...
def corrupt_mnist(dir: str) -> tuple[torch.utils.data.Dataset, torch.utils.data.Dataset]:
    """Return train and test datasets for corrupt MNIST."""
    train_images = torch.load(dir+"train_images.pt")
    train_target = torch.load(dir+"train_target.pt")
    test_images = torch.load(dir+"test_images.pt")
    test_target = torch.load(dir+"test_target.pt")
